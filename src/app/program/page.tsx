...
export default function ProgramPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-[#1a1a1a] flex items-center justify-center px-6 w-full max-w-full overflow-x-hidden">
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white w-full max-w-full overflow-x-hidden">
      {/* Header */}
      <div className="border-b border-white/5 bg-[#0A0A0A] sticky top-0 z-10 w-full max-w-full overflow-hidden">
