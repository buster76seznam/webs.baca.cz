          ...
          <div className="hidden lg:flex gap-14 text-[11px] font-black uppercase tracking-[0.3em] text-zinc-500">
            {['why', 'pricing', 'process', 'specialization', 'work'].map((item) => (
              <a key={item} href={`#${item}`} className="hover:text-brand transition-all duration-300 hover:tracking-[0.4em]">
                {item === 'why' ? t.footerWhy : item === 'pricing' ? t.footerPricing : item === 'process' ? t.footerProcess : item === 'specialization' ? t.footerSpecialization : (isEnglish ? 'Our Work' : 'Naše práce')}
              </a>
            ))}
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-20 mb-32">
            ...
            <div className="lg:col-span-3">
               ...
               <div className="grid grid-cols-2 gap-6 text-sm font-bold text-zinc-400 uppercase tracking-[0.2em]">
                  ...
                  <a href="#work" className="hover:text-white transition-all duration-300">{isEnglish ? "Our Work" : "Naše práce"}</a>
               </div>
            </div>
          </div>
