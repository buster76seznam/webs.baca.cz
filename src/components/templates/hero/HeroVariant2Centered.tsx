...
export default function HeroVariant2Centered({ hero, companyName }: Props) {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-32 w-full max-w-full overflow-hidden bg-slate-900 anti-overflow-container">
      ...
      {/* Animated Glows */}
<div
  className="absolute top-[-15%] left-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] max-w-full rounded-full blur-[80px] md:blur-[120px] pointer-events-none"
  style={{ backgroundColor: 'var(--color-primary)', opacity: 0.15 }}
/>
<div
  className="absolute bottom-[-15%] right-0 w-[250px] md:w-[500px] h-[250px] md:h-[500px] max-w-full rounded-full blur-[80px] md:blur-[120px] pointer-events-none"
